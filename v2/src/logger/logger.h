...
# define XKBLAS_PRINT_INFO_ID     0
# define XKBLAS_PRINT_WARN_ID     1
# define XKBLAS_PRINT_ERROR_ID    2
# define XKBLAS_PRINT_DEBUG_ID    3
# define XKBLAS_PRINT_FATAL_ID    4

extern char * XKBLAS_PRINT_COLORS[4];
extern char * XKBLAS_PRINT_HEADERS[4];
...
# define XKBLAS_PRINT(LVL, ...)                                     \
    do {                                                            \
        ...
        {                                                           \
            fprintf(stderr,                                         \
                    "%s:%s (%s)", __FILE__, __LINE__, __func__);    \
            abort();                                                \
        }                                                           \
    } while (0)
