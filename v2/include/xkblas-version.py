...
if len(sys.argv) != 2:
    print("usage: {} [DST-FILE]".format(sys.argv[0]))
    sys.exit(0)
...
cmd('sed "s/£GIT_HASH/$(git describe --abbrev=4 --dirty --always --tags)/g" {}/{}-template.h > {}/{}-tmp.h'.format(dstdir, dstfile, dstdir, dstfile))
