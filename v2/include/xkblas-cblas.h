#ifndef __XKBLAS_CBLAS_H__
# define __XKBLAS_CBLAS_H__
...
static inline int
xkblas_blas2cblas_trans(const char* trans)
{
    switch (trans[0])
    {
        case 'n':
...
static inline int
xkblas_blas2cblas_side(const char * side)
{
    switch (side[0]) {
        case 'l':
...
static inline int
xkblas_blas2cblas_fill(const char * uplo)
{
    switch (uplo[0])
    {
        case 'l':
...
static inline int
xkblas_blas2cblas_diag( const char* diag )
{
    switch (diag[0])
    {
        case 'n':
