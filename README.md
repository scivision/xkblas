...
## Example
An XKBlas program is a sequence of task-spawning BLAS routines call over host-memory matrices, that are automatically tiled and distributed to multiple GPUs in an asynchronous fashion.
