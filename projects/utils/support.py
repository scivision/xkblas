...
if len(sys.argv) != 10:
    print("usage: {} [DST-DIR] [DST-FILE] [USE_CUDA] [USE_ZE] [USE_SYCL] [USE_CL] [USE_STATS] [USE_CAIRO] [USE_NVML]".format(sys.argv[0]))
    sys.exit(0)
...
cmd('sed -e "s/__XKRT_SUPPORT_CUDA_VALUE__/{}/g" -e "s/__XKRT_SUPPORT_ZE_VALUE__/{}/g" -e "s/__XKRT_SUPPORT_SYCL_VALUE__/{}/g" -e "s/__XKRT_SUPPORT_CL_VALUE__/{}/g" -e "s/__XKRT_SUPPORT_STATS_VALUE__/{}/g" -e "s/__XKRT_SUPPORT_CAIRO_VALUE__/{}/g" -e "s/__XKRT_SUPPORT_NVML_VALUE__/{}/g" {}/{}.template > {}/{}-tmp.h'.format(use_cuda, use_ze, use_sycl, use_opencl, use_stats, use_cairo, use_nvml, dstdir, dstfile, dstdir, dstfile))
