...
if len(sys.argv) != 15:
    print("usage: {} [DST-DIR] [DST-FILE] [USE_CUDA] [USE_ZE] [USE_SYCL] [USE_CL] [USE_STATS] [USE_CAIRO] [USE_NVML] [USE_ZES] [USE_RSMI] [ENABLE_HEAVY_DEBUG] [USE_ZE_SYCL_INTEROP] [USE_HIP]".format(sys.argv[0]))
    sys.exit(0)
