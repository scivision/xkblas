...
# include <xkrt/device/memory-access.hpp>
...
# if USE_STATS
void xkrt_stats_task_state_incr(task_format_id_t fmtid, task_state_t state);
# else
...
void xkrt_task_ready(Task * task);
