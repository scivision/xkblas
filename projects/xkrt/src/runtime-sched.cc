...
void
xkrt_runtime_t::power_start(const xkrt_device_global_id_t device_global_id, xkrt_power_t * power)
{
    assert(power);
...
void
xkrt_runtime_t::power_stop(const xkrt_device_global_id_t device_global_id, xkrt_power_t * power)
{
    assert(power);
