...
static void
xkblas_cblas_sync(void)
{
    static int invalidate_caches = -1;
    if (invalidate_caches == -1)
    {
        const char * s = getenv("XKBLAS_CBLAS_INVALIDATE_CACHES");
        invalidate_caches = s ? atoi(s) : 1;
    }
